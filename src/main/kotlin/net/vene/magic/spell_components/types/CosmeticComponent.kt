...
class CosmeticComponent(override val name: String, override val instability: Double = 0.0, spellMethod: SpellRunnable) : MagicEffect(name, instability, spellMethod) {
